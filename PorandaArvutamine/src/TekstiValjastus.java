 ...
 * @author User
 */
public class TekstiValjastus extends JLabel 
    ...
    public TekstiValjastus(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    public TekstiValjastus(String text, JTextComponent component, Show show) {
